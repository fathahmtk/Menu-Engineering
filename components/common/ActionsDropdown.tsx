  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center text-muted-foreground px-3 py-2 rounded-lg hover:bg-accent transition-colors border border-border"
        aria-haspopup="true"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 origin-top-right bg-card rounded-xl shadow-lg ring-1 ring-border z-50">
          <div className="py-1">
            <a
              href="#"
